...
|------------|--------|------|
| Settore (top vs bottom NACE) | +247% | Petrolio/gas €30.15 vs servizi persona €8.70 |
...
4. **Gap di genere settorialmente differenziato**: il differenziale M/F varia da -6% a +59% tra settori, con picchi nel trasporto aereo/marittimo e valori negativi nelle costruzioni
...
11. **Interazione settore-territorio**: il gap Nord-Sud varia significativamente per settore, con "settori equalizzatori" (basso CV territoriale) e "settori polarizzatori" (alto CV territoriale), indicando che il divario territoriale dipende dalla composizione settoriale locale
