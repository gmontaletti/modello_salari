...
knitr::include_graphics("output/racli/grafici/23_mappa_disuguaglianza_D9_D1.png")
```
...
knitr::include_graphics("output/racli/grafici/24_mappa_cluster_province.png")
```
...
knitr::include_graphics("output/racli/grafici/17_scatter_salari_dispersione_settori.png")
```
...
knitr::include_graphics("output/racli/grafici/18_gap_genere_settori.png")
```
...
knitr::include_graphics("output/racli/grafici/15_top_bottom_province.png")
```
